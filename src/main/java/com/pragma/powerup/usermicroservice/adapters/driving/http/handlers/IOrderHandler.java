...
public interface IOrderHandler {
    void addOrder(OrderRequestDto orderRequestDto, HttpServletRequest request);
    void addOrders(List<OrderRequestDto> orderRequestDtos, HttpServletRequest request);
    OrderDishResponseDto takeOrder();
